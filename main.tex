...
% \lstset{caption={Astro645HW04.py}, style=Python}
% %\label{sec:CodeHw04p1}
% %\lstset{label={Astro732Hw04P1.py}}
% \lstinputlisting[language=Python]{CodeAndFigures/Astro645HW04.py}

% \newpage

% %\section[]{Python code Problem 3} 
% \lstset{caption={Astro645HW04p3.py}, style=Python}
% \lstinputlisting[language=Python]{CodeAndFigures/Astro645HW04p3.py}

% \newpage

% %\section[]{Python code Problem 4} 
% \lstset{caption={Astro645HW04p4.py}, style=Python}
% \lstinputlisting[language=Python]{CodeAndFigures/Astro645HW04p4.py}
